...
**YOU ARE IN: `enhancements/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/enhancements/` (rig root) or other directories
...
**Your mail address:** `enhancements/polecats/rust`
**Your rig:** enhancements
**Your Witness:** `enhancements/witness`
...
| Ask Witness for help | `gt mail send enhancements/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`enhancements/witness`) when:
...
```bash
gt mail send enhancements/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
